...
#es treballa amb augmentació estàtica al disc
"""
...
model = tf.keras.Sequential([
    ...
    tf.keras.layers.Dense(n_classes, activation='softmax', dtype='float32')  # Adjusted for n_classes and softmax
...
img_path = 'data/test/malignant/52.jpg'
